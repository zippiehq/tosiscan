          ...
          {asset?.id === '0x80bf3a24' ?
            <Box>
              <Typography variant='body2' mb={2} sx={{ fontSize: '16px', lineHeight: 1.5, color: '#475467' }}>
                Lohko carbon credit futures are issued from a high-quality tropical reforestation project that prioritizes original forest growth, biodiversity, and community livelihood.
              </Typography>
        ...
        <div className='profile'>
          ...
          <div style={{ justifyContent: 'space-between' }} className='flex'>
            <div className='website'>
              <a
                href='https://app.lohkoinvest.com/'
                target='_blank'
                rel='noreferrer nofollow'
              >
                app.lohkoinvest.com
